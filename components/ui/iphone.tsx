...
export function Iphone({
  ...
  return (
    ...
    >
      ...
      {props.children && (
        <div
          className="absolute z-0 overflow-hidden bg-[#E5ECE9] dark:bg-black"
          style={{
            left: `${LEFT_PCT}%`,
            top: `${TOP_PCT}%`,
            width: `${WIDTH_PCT}%`,
      ...
      >
        <g mask={hasMedia || props.children ? "url(#screenPunch)" : undefined}>
          <path
        ...
        <path
          ...
          mask={hasMedia || props.children ? "url(#screenPunch)" : undefined}
        />
